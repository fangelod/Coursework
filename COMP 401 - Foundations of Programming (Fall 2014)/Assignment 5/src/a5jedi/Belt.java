...
public class Belt implements Iterable<Plate>{
	...
	/* Input: position
	 * Output: Iterator<Plate>
	 * This method returns a new BeltIterator object with a 
	 * constructor considering price with a starting position at the 
	 * inputted position.
	 */
	public Iterator<Plate> iteratorFromPosition(int position, double max_price) {
		Iterator<Plate> from_pos_price = new BeltIterator(this, position, max_price);
		
		return from_pos_price;
	}
	 ...
	 * Output: Iterator<Plate>
	 * This method returns a new BeltIterator object with a 
	 * constructor considering color with a starting position at the
	 * inputted position.
	 */
	public Iterator<Plate> iteratorFromPosition(int position, Plate.Color color) {
		Iterator<Plate> from_pos_color = new BeltIterator(this, position, color);
		
		return from_pos_color;
	}
