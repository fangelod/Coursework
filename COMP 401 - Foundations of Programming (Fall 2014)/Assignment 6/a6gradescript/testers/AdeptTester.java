...
public class AdeptTester {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.err.println("Fails plate counter test");
		}
		try {
			num_tests++;
			profitCounterTest();
			...
			points_off += 1;
			System.err.println(e.getMessage());
			System.err.println("Fails profit counter test");
		}
		try {
			num_tests++;
			clearAndRemoveTest();
			...
			points_off += 1;
			System.err.println(e.getMessage());
			System.err.println("Fails clear and remove test");
		}
		try {
			num_tests++;
			twoBeltsOneCounterTest();
			num_tests_passed++;
		} catch (Throwable e) {
			points_off += 1;
			System.err.println(e.getMessage());
			System.err.println("Fails two belts one counter test");
		}
	...
	public static void plateCounterTest() {
	...
	public static void profitCounterTest() {
	...
	public static void clearAndRemoveTest() {
	...
	public static void twoBeltsOneCounterTest() {
